...
const AboutUs = () => {
  return (
    <Container>
      <div className="pt-[30px] pb-14 md:py-[120px] grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-[133px]">
        <div>
          <img src={about_us} alt="About Us" className="w-[343px] h-[433px] md:w-[543px] md:h-[558px] object-contain" />
        </div>
        <div>
